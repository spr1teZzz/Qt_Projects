...
QT_MOC_LITERAL(3, 23, 16) // "loginWindowClose"

    },
    "loginWidget\0loginUser\0\0loginWindowClose"
};
...
void loginWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->loginUser((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        ...
        {
            typedef void (loginWidget::*_t)(int , QString );
...
// SIGNAL 0
void loginWidget::loginUser(int _t1, QString _t2)
{
