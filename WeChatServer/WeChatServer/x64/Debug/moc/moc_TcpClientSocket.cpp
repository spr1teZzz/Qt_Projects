...
QT_MOC_LITERAL(3, 30, 18), // "clientdisconnected"
QT_MOC_LITERAL(4, 49, 7), // "qintptr"
QT_MOC_LITERAL(5, 57, 14), // "connectsuccess"
QT_MOC_LITERAL(6, 72, 11), // "receivedata"
QT_MOC_LITERAL(7, 84, 22) // "slotclientdisconnected"

    },
    "TcpClientSocket\0updateserver\0\0"
    "clientdisconnected\0qintptr\0connectsuccess\0"
    "receivedata\0slotclientdisconnected"
};
...
void TcpClientSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateserver((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 1: _t->clientdisconnected((*reinterpret_cast< qintptr(*)>(_a[1]))); break;
        case 2: _t->connectsuccess((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< qintptr(*)>(_a[2]))); break;
        ...
        {
            typedef void (TcpClientSocket::*_t)(QString , int , int );
        ...
        {
            typedef void (TcpClientSocket::*_t)(int , qintptr );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpClientSocket::connectsuccess)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void TcpClientSocket::updateserver(QString _t1, int _t2, int _t3)
{
...
// SIGNAL 1
void TcpClientSocket::clientdisconnected(qintptr _t1)
{
...
// SIGNAL 2
void TcpClientSocket::connectsuccess(int _t1, qintptr _t2)
{
